...
public class Scheduler {
    ...
    public static void main(String[] args) {
        ArrayList<Process> processes1 = new ArrayList<>(); // task1
        ...
        ArrayList<Process> processes2 = new ArrayList<>(); // task2
        ...
        ArrayList<Process> processes3 = new ArrayList<>(); // task3
        ...
        ArrayList<Process> processes4 = new ArrayList<>(); // task4
        ...
        ArrayList<Process> processes5 = new ArrayList<>(); // task5
